...
void main() {
	...
	`}var Ga=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new si(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var _s={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function vs(e,t){let n=_s[t];return n===void 0?(W(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var ys=new J;function bs(){return X.getLuminanceCoefficients(ys),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${ys.x.toFixed(4)}, ${ys.y.toFixed(4)}, ${ys.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`;function Pc(e,t){let n=new Set,r=e=>n.forEach(t=>t(e));return i=>(n.size===0&&e().addEventListener(t,r,{passive:!0}),n.add(i),()=>{n.delete(i),n.size===0&&e().removeEventListener(t,r)})}var Fc=Pc(()=>document,`pointermove`),Ic=Pc(()=>window,`scroll`),Lc=Pc(()=>window,`resize`);function Rc(e,t){let n=e.trim();if(!n.startsWith(`var(`))return n;let r=n.slice(4,-1).split(`,`)[0].trim();return getComputedStyle(t).getPropertyValue(r).trim()||`#ffffff`}function zc({className:e=``,variation:t=0,pixelRatioProp:n=2,shapeSize:i=1.2,roundness:a=.4,borderSize:o=.05,circleSize:s=.3,circleEdge:c=.5,color:l=`#ffffff`,color2:u=``,baseBlur:d=.2,reduced:f=!1,autoMotion:p=!1,autoShape:m=`figure8`,autoSpeed:h=.6,autoCenterX:g=.25,autoCenterY:_=.5,autoRadiusX:v=.18,autoRadiusY:y=.28,grainAmount:b=0,grainScale:x=1,paused:S=!1}){let C=(0,r.useRef)(null),w=(0,r.useRef)(!1),T=(0,r.useRef)(()=>{}),E={color:l,color2:u,baseBlur:d,shapeSize:i,roundness:a,borderSize:o,circleSize:s,circleEdge:c,grainAmount:b,grainScale:x},D=(0,r.useRef)(E);(0,r.useEffect)(()=>{D.current=E});let O=(0,r.useRef)(null),k=(0,r.useRef)(()=>{});return(0,r.useEffect)(()=>{let e=C.current;if(!e)return;let r=p&&!f,i=!0,a=!1,o=!0,s=0,c=0,l=0,u=0,d=0,b=new q,x=new q,S=new q,E=1,A=1,j=new Mn,ee=new Yi;ee.position.z=1;let M=new Ac({alpha:!0});M.setClearColor(0,0),e.appendChild(M.domElement);let te=new fi(1,1),N=D.current,P=new xi({vertexShader:Mc,fragmentShader:Nc,uniforms:{u_mouse:{value:x},u_resolution:{value:S},u_pixelRatio:{value:n},u_color:{value:new Z(Rc(N.color,e))},u_color2:{value:new Z(Rc(N.color2||N.color,e))},u_baseBlur:{value:N.baseBlur},u_shapeSize:{value:N.shapeSize},u_roundness:{value:N.roundness},u_borderSize:{value:N.borderSize},u_circleSize:{value:N.circleSize},u_circleEdge:{value:N.circleEdge},u_grainAmount:{value:N.grainAmount},u_grainScale:{value:N.grainScale}},defines:{VAR:t},transparent:!0});O.current=P;let ne=new Yr(te,P);j.add(ne);let F=e.getBoundingClientRect(),re=-1/0,ie=()=>{F=e.getBoundingClientRect()},I=0,ae=()=>{re=performance.now(),clearTimeout(I),I=window.setTimeout(ie,120)},oe=.05,L=()=>Math.abs(x.x-b.x)<oe&&Math.abs(x.y-b.y)<oe,se=()=>{if(!i)return;if(w.current){a=!1;return}if(c=performance.now()*.001,r&&o&&(performance.now()-re<120||c-u<.03333333333333333)){s=requestAnimationFrame(se);return}u=c;let t=c-l;l=c;let n=Math.min(t,.1);if(r&&(d+=n*h),r){let t=e.offsetParent,n=t?t.clientWidth:E,r=t?t.clientHeight:A,i=n*g,a=r*_,o=n*v,s=r*y,c=d,l=m===`figure8`?i+o*Math.sin(c):i+o*Math.cos(c),u=m===`figure8`?a+s*Math.sin(2*c):a+s*Math.sin(c);b.set(l-e.offsetLeft,u-e.offsetTop)}[`x`,`y`].forEach(e=>{x[e]=Et.damp(x[e],b[e],8,n)}),M.render(j,ee),o&&(r||!L())?s=requestAnimationFrame(se):a=!1},ce=()=>{a||!i||!o||f||w.current||(a=!0,l=performance.now()*.001,s=requestAnimationFrame(se))};T.current=ce,k.current=()=>M.render(j,ee);let le=Fc(e=>{let t=e;!o||f||performance.now()-re<120||(b.set(t.clientX-F.left,t.clientY-F.top),ce())}),ue=Ic(ae),de=()=>{if(!i)return;E=e.clientWidth,A=e.clientHeight;let t=Math.min(window.devicePixelRatio,n);M.setSize(E,A),M.setPixelRatio(t),ee.left=-E/2,ee.right=E/2,ee.top=A/2,ee.bottom=-A/2,ee.updateProjectionMatrix(),ne.scale.set(E,A,1),S.set(E,A).multiplyScalar(t),P.uniforms.u_pixelRatio.value=t,ie(),M.render(j,ee)};de();let fe=Lc(de),R=new ResizeObserver(()=>{i&&de()});R.observe(e);let pe=new IntersectionObserver(([e])=>{o=e.isIntersecting,o&&ce()},{rootMargin:`100px`});return pe.observe(e),r&&ce(),()=>{i=!1,a=!1,cancelAnimationFrame(s),clearTimeout(I),fe(),ue(),le(),R.disconnect(),pe.disconnect(),O.current=null,k.current=()=>{},e.contains(M.domElement)&&e.removeChild(M.domElement),te.dispose(),P.dispose(),M.dispose(),M.forceContextLoss()}},[t,n,f,p,m,h,g,_,v,y]),(0,r.useEffect)(()=>{let e=O.current,t=C.current;if(!e||!t)return;let n=e.uniforms;n.u_color.value.set(Rc(l,t)),n.u_color2.value.set(Rc(u||l,t)),n.u_baseBlur.value=d,n.u_shapeSize.value=i,n.u_roundness.value=a,n.u_borderSize.value=o,n.u_circleSize.value=s,n.u_circleEdge.value=c,n.u_grainAmount.value=b,n.u_grainScale.value=x,k.current()},[l,u,d,i,a,o,s,c,b,x]),(0,r.useEffect)(()=>{w.current=S,S||T.current()},[S]),(0,jc.jsx)(`div`,{className:e,ref:C,style:{width:`100%`,height:`100%`}})}export{zc as default};